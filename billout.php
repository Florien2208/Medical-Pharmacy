...
<body style="background: #ECF0F5;padding:0;margin:0">
  ...
  <div class="content2">
    ...
    <div class="well well-sm" style="width: 77%;margin: auto;">
      <table class="table table-bordered table-striped">
        ...
        <tr>
          <th colspan="5" class="center"><h3>Purchase Item Details</h3></th>
        </tr>
          <tr>
        <th>#</th>
        <th>Medicine Name</th>
  ...
  <tr>
    <td colspan="3" style="text-align: right;">COPAY</td><th style="border-bottom: 1px solid blue;"><?php echo $_POST['discount']; ?></th>
  </tr>
  <tr>
    <td colspan="3" style="text-align: right;border-right: 1px solid blue">RSSB</td><th style="border: 1px solid blue;"><?php echo $total-$_POST['discount']; ?></th>
  </tr>
  <tr>
...
$total = $total-$_POST['discount'];
    if (!$con->query("insert into sold (name,supplier,contact,discount,amount,item,userId) values ('$_POST[name]',' $row[supplier]','$_POST[contact]','$_POST[discount]','$total','$i','$_SESSION[userId]')")) 
    {
